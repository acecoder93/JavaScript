function nav(){
    ...
    return nav; // returning the value of the entire nav div
 }
 ...
 var navGlobal = nav(); // setting a variable equivalent to calling the nav function
 container.appendChild(navGlobal); // appending the "called" - nav function, to the container
